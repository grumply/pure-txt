...
module Pure.Data.Txt.Internal.GHCJS (module Pure.Data.Txt.Internal.GHCJS, module Export) where
...
readError ty t = error ("Pure.Data.Txt.fromTxt: failed to read an " ++ ty ++ " when given: " ++ show t)
